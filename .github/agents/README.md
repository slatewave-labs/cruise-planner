...
This directory contains custom agent files (`.agent.md`) that give your AI coding assistant a specific persona and project-aware rules. They appear directly in the **agents dropdown** in Copilot Chat.
...
4. Type your request — the AI adopts that agent's expertise and rules
