...
class LLMClient:
    ...
    def generate_day_plan(
        self,
        prompt: str,
        system_instruction: str = "You are an expert cruise port day planner. You always respond with valid JSON only, no markdown.",
    ...
    def parse_json_response(self, response_text: str) -> Dict[str, Any]:
        ...
        # Remove markdown code fences if present (shouldn't happen with json_object mode)
        if clean.startswith("```"):
